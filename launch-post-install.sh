...
echo "*/5 * * * * date >> /var/log/workspace_backup.log && gdrive sync upload /Users/BENJAMIN/Workspace/* 1FeSKwf60nnl0sZFUQCoohbBMsFgw385h >> /var/log/workspace_backup.log" >> /tmp/matable
crontab /tmp/matable
rm /tmp/matable
